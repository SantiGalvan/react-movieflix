        ...
        <header className="h-[100px] bg-gray-950 flex px-6 items-center justify-between" >
            ...
            <div>
                <select
                    ...
                    <option className="hover:bg-red-600 text-base active:bg-red-600" value="Pippo">Pippo</option>
                    <option className="hover:bg-red-600 text-base active:bg-red-600" value="Giulio">Giulio</option>
                </select>
